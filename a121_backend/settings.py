...
SECRET_KEY = 'your-secret-key-here'  # Substitua por uma chave secreta segura em produção
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware',  # Para suporte a múltiplos idiomas
